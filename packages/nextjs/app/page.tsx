    ...
    <div className="flex items-center flex-col flex-grow pt-10">
      <div className="px-5 w-[90%] md:w-[75%]">
        <h1 className="text-center mb-6">
          <span className="block text-2xl mb-2">Decentralized staking App</span>
          <span className="block text-4xl font-bold">Decentralized Staking App With QuickNode</span>
        </h1>
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="max-w-3xl">
            <p className="text-center text-lg mt-8">
              ...
              adversarial group of players can use to work together. In this dApp, you have a decentralized
